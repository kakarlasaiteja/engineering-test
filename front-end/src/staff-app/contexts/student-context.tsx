...
const getSortedStudents = (students: any[] | undefined, sortBy: any, sortDirection: any) => {
  if (sortDirection === "none") {
    return students?.sort((a: any, b: any) => a.id - b.id)
  }
  return (
    students &&
  ...
  switch (action.type) {
    ...
    case UPDATE_DISPLAYED_STUDENTS:
      ...
      return {
        ...state,
        displayedStudents:
          stateTobeFiltered === "all" || !stateTobeFiltered
            ? getSortedStudents(serachFilteredStudents, sortBy, sortDirection)
            : serachFilteredStudents &&
              getSortedStudents(serachFilteredStudents, sortBy, sortDirection)?.filter((student: any) => {
